package com.dystudio.aimee.web.rest;

import com.dystudio.aimee.AimeeApp;
import com.dystudio.aimee.domain.JobHistory;
import com.dystudio.aimee.repository.JobHistoryRepository;
import com.dystudio.aimee.repository.search.JobHistorySearchRepository;
import com.dystudio.aimee.service.JobHistoryService;
import com.dystudio.aimee.web.rest.errors.ExceptionTranslator;
...
import static com.dystudio.aimee.web.rest.TestUtil.createFormattingConversionService;
...
import com.dystudio.aimee.domain.enumeration.Language;
/**
 * Integration tests for the {@link JobHistoryResource} REST controller.
 */
@SpringBootTest(classes = AimeeApp.class)
public class JobHistoryResourceIT {
    ...
    /**
     * This repository is mocked in the com.dystudio.aimee.repository.search test package.
     *
     * @see com.dystudio.aimee.repository.search.JobHistorySearchRepositoryMockConfiguration
     */
    @Autowired
